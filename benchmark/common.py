...
def write_results_csv(path: Path, rows: Iterable[Dict[str, object]]) -> None:
    fieldnames = [
        ...
        "Clean Acc (Purified)",
        "Target Acc (Purified)",
        "Natural Accuracy (Poison)",
        "Attack Success/ASR (Poison)",
        "Target-Class Accuracy (Poison)",
        "Natural Accuracy (Purified)",
        "Attack Success/ASR (Purified)",
        "Target-Class Accuracy (Purified)",
        "Purification Images",
        "Purification Seconds",
        "Purification Seconds/Image",
        "Purification Images/Second",
        "Purification Mean Batch Seconds/Image",
        "Purification Median Batch Seconds/Image",
        "Purification Batch Size",
        "Purification Device",
        "Purification Timestep",
        "Purification Seed",
        "Purifier Checkpoint SHA256",
        "Purification Reused",
    ]
    path.parent.mkdir(parents=True, exist_ok=True)
